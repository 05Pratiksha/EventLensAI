...
export default function GuestEventPage() {
  ...
  return (
    <div className="min-h-screen bg-background relative flex flex-col items-center pb-20 transition-colors duration-300">
      <GradientBackground />
      ...
      <div className="relative z-20 w-full max-w-lg px-6 -mt-32">
        ...
        >
          ...
          <p className="text-xs text-muted-foreground font-semibold tracking-wide uppercase">{event.date}</p>
        </motion.div>
            ...
            <div className="space-y-6">
                ...
                <div className={`border border-dashed rounded-xl overflow-hidden transition-all duration-300 ${preview ? 'border-primary/50 bg-secondary/50' : 'border-border bg-secondary/35 hover:border-primary/40 hover:bg-secondary p-12 text-center'}`}>
                  {preview ? (
                    ...
                    <>
                      ...
                      <p className="text-[10px] text-muted-foreground">or upload from device gallery</p>
                    </>
                  )}
                </div>
              </div>
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <div className="relative flex items-center justify-center mt-0.5 shrink-0">
                  ...
                  />
                  {consent && <ShieldCheck className="w-3.5 h-3.5 text-[#060608] dark:text-background absolute pointer-events-none" />}
                </div>

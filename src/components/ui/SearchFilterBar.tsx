  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 mb-6">
      ...
      <div className="flex gap-2">
        ...
        <select className="h-10 rounded-md border border-white/10 bg-white/5 px-3 py-2 text-sm text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
